...
export const cacheUsersService = async (req: RequestCustom, res: Response) => {
  try {
...
export const getAllUsersService = async (req: RequestCustom, res: Response) => {
  try {
...
export const getUserByIdService = async (req: RequestCustom, res: Response) => {
...
export const updateUserService = async (req: RequestCustom, res: Response) => {
  const userId = req.params.id;
  const data = req.body;
  const file = req.file;
...
export const deleteUserService = async (req: RequestCustom, res: Response) => {
  const userId = req.params.id;
